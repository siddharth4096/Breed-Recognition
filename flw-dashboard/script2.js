...
async function compareWithReference(testDataUrl, refUrl) {
  return new Promise((resolve) => {
...
async function captureAndPredict() {
  ...
  if (!dataUrl) return alert('No camera available or permission denied.');
    ...
    // Compare against reference Gir & Sahiwal images
  ...
  if (girScore < sahiwalScore) {
    top3 = [
      { label: "Gir", score: 92 },
      { label: "Sahiwal", score: 6 },
      { label: "Other", score: 2 }
    ];
  } else {
    top3 = [
      { label: "Sahiwal", score: 91 },
      { label: "Gir", score: 7 },
      { label: "Other", score: 2 }
    ];
  }
  ...
  displayResults(top3, dataUrl, { origin: "Demo", notes: "Reference image match demo" });
  ...
  uploadInput.addEventListener("change", async (ev) => {
    ...
    reader.onload = async (e) => {
      ...
      if (girScore < sahiwalScore) {
        ...
        top3 = [
          { label: "Sahiwal", score: 90 },
          { label: "Red Sindhi", score: 8 },
          { label: "Other", score: 2 }
        ];
      }

      displayResults(top3, dataUrl, { origin: "Upload", notes: "Reference match demo" });
      showPredictionForConfirm(top3, dataUrl);
    };
